...
# Windows使用下面语句 64位32位机器都是--win32
npm install electron --save-dev --win32
...
![electron main window](https://imgup.qii404.me/electron-main-windows.png)
...
![electron-wechat-login](https://imgup.qii404.me/electron-wechat.png)

        ...
        'git':
            [
                
                    {
                        ...
                        'date':'2016-01-22',
                        'excerpt':'<p>普通的<code class="highlighter-rouge">git diff</code>时展示的是一行一行的，添加一个词很不容易观察，如图</p>',
                        'tags':[
        ...
        'software':
            [
                
                    {
                        ...
                        'date':'2015-12-07',
                        'excerpt':'<p>Charles未破解版本，每次打开都要<code class="highlighter-rouge">relay 10秒钟</code>，重要的是，隔一段时间还会弹出一个提示框，说【<em>你还没注册，快点去买正版吧。。。</em>】</p>',
                        'tags':[
        ...
        'hacker':
            [
                
                    {
                        ...
                        'date':'2016-07-29',
                        'excerpt':'<p>经常远程登录服务器然后进行操作的程序猿童鞋们对于 ssh 肯定不会陌生，<code class="highlighter-rouge">ssh name@host</code>之后直接输入密码即可登录到远端主机，不过稍稍麻烦的地方是每次都需要输入密码，如果密码固定还好说，可以用终端的Trigger或者用Linux的expect自动输入密码；但如果是需要token的那种，每次都要输入固定密码前缀，然后再找出token输入，这样的话难免让人着急。</p>',
                        'tags':[
                    ...
                    {
                        'url':'/2015/11/09/goagent.html',
                        'title':'手把手教你科学上网(翻墙)',
                        'date':'2015-11-09',
                        'excerpt':'<p>我们生活在一面看不见的墙里，这面墙似有似无，似是而非，朦胧而又强大。好像一扇囚笼，让以为这就是世界的我们，惬意安然的活着。</p>',
                        'tags':[
        ...
        'opensource':
            [
                ...
                
                    {
                        ...
                        'date':'2017-04-17',
                        'excerpt':'<p><strong>是不是每个爱折腾的人都有搭建一套自己的Gitlab服务器的冲动~</strong> 哼哼，我就是一个爱折腾的人，曾经也搭建过Gitlab环境，装Redis，装PostgreSQL，装Ruby，装Gitlab，尤其是配置Ruby环境跑Gitlab的时候，卧槽那个坑！不过今天，我再次搭建Gitlab服务，用的是大神已经配置好的Gitlab Docker镜像，哈哈，轻松极了~</p>',
                        'tags':[
        ...
        'php':
            [
                
                    {
                        ...
                        'date':'2016-12-30',
                        'excerpt':'<p>工作生产环境是<code class="highlighter-rouge">hhvm</code> + <code class="highlighter-rouge">php5.2</code> ，是的，php版本有点低，然后在不支持 Closure [其实就是匿名函数] 这种作为 callback 函数的情况下，用了<code class="highlighter-rouge">create_function</code>方法代替了callback，结果出坑了，线上机器 cpu400% 占用…</p>',
                        'tags':[
                ...
                
                    {
                        ...
                        'date':'2016-09-26',
                        'excerpt':'<p>今天用php在后台跑一些常规任务的时候使用到了exec函数，它用来执行Linux系统函数进行相关统计，如<code class="highlighter-rouge">exec("ls -l")</code>，但是却发生了很诡异的问题，真的是特别诡异的问题，首先看下面这段代码</p>',
                        'tags':[
